...
exports.GrpcError = exports.GrpcStatus = exports.ApiUrls = exports.SortDirection = exports.MessageApi = void 0;
...
class ApiClient {
    constructor(pathPrefix, opts) {
        ...
        this.version = 'xmtp-js/' + package_json_1.default.version;
    ...
    async _query(req) {
        try {
            return await (0, utils_1.retry)(exports.MessageApi.Query, [
                req,
                {
    ...
    async _publish(req, attemptNumber = 0) {
        ...
        try {
            return await (0, utils_1.retry)(exports.MessageApi.Publish, [
                req,
                {
                    pathPrefix: this.pathPrefix,
                    mode: 'cors',
    ...
    _subscribe(req, cb) {
        ...
        const doSubscribe = async () => {
            while (true) {
                ...
                try {
                    await exports.MessageApi.Subscribe(req, cb, {
                        pathPrefix: this.pathPrefix,
    ...
    async query(params, { direction = exports.SortDirection.SORT_DIRECTION_ASCENDING, limit, }) {
        const out = [];
