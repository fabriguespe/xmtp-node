...
exports.SealedInvitation = exports.SealedInvitationV1 = exports.SealedInvitationHeaderV1 = exports.InvitationV1 = void 0;
...
class InvitationV1 {
    ...
    static createRandom(context) {
        const topic = (0, utils_1.buildDirectMessageTopicV2)(Buffer.from(crypto_1.default.getRandomValues(new Uint8Array(32)))
            .toString('base64')
            .replace(/=*$/g, '')
            ...
            .replace('/', '-'));
        const keyMaterial = crypto_1.default.getRandomValues(new Uint8Array(32));
...
class SealedInvitationV1 {
    ...
    async getInvitation(viewer) {
        ...
        const decryptedBytes = await (0, crypto_2.decrypt)(this.ciphertext, secret, this.headerBytes);
...
class SealedInvitation {
    ...
    static async createV1({ sender, recipient, created, invitation, }) {
        ...
        const ciphertext = await (0, crypto_2.encrypt)(invitationBytes, secret, headerBytes);
