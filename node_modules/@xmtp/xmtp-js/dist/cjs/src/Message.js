...
class MessageV1 extends MessageBase {
    ...
    static async create(obj, header, bytes) {
        ...
        const id = (0, utils_1.bytesToHex)(await (0, encryption_1.sha256)(bytes));
    ...
    async decrypt(keystore, myPublicKeyBundle) {
        const responses = (await keystore.decryptV1((0, keystore_1.buildDecryptV1Request)([this], myPublicKeyBundle))).responses;
        if (!responses.length) {
...
class DecodedMessage {
    ...
    toBytes() {
        return proto_1.message.DecodedMessage.encode({
            ...this,
            conversation: {
            ...
            sentNs: (0, utils_2.dateToNs)(this.sent),
        }).finish();
    }
    static async fromBytes(data, client) {
        ...
        return new DecodedMessage({
            ...
            error,
            messageVersion,
            sent: (0, utils_2.nsToDate)(protoVal.sentNs),
...
async function decodeContent(contentBytes, client) {
    ...
    let error;
    await (0, Compression_1.decompress)(encodedContent, 1000);
