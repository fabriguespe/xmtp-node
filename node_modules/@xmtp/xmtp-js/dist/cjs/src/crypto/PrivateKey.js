...
class SignedPrivateKey {
    ...
    async signKey(pub) {
        ...
        const digest = await (0, encryption_1.sha256)(keyBytes);
    ...
    static async signerKey(key, signature) {
        const digest = await (0, encryption_1.sha256)(key.bytesToSign());
