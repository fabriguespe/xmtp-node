...
exports.decodePrivateKeyBundle = exports.PrivateKeyBundleV1 = exports.PrivateKeyBundleV2 = void 0;
...
class PrivateKeyBundleV2 {
    ...
    static async generate(wallet) {
        const identityKey = await PrivateKey_1.SignedPrivateKey.generate(new Signature_1.WalletSigner(wallet));
    ...
    async addPreKey() {
        ...
        const preKey = await PrivateKey_1.SignedPrivateKey.generate(this.identityKey);
