...
const MS_NS_TIMESTAMP_THRESHOLD = new long_1.default(10 ** 9).mul(10 ** 9);
...
class UnsignedPublicKey {
    ...
    async verifyKey(pub) {
        ...
        const digest = await (0, encryption_1.sha256)(pub.bytesToSign());
...
class PublicKey extends UnsignedPublicKey {
    ...
    async signWithWallet(wallet) {
        const sigString = await wallet.signMessage(Signature_1.WalletSigner.identitySigRequestText(this.bytesToSign()));
