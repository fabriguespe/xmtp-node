...
const encodeV1 = () => {
    return MESSAGE_SIZES.map((size) => add(`encode and encrypt a ${size} byte v1 message`, async () => {
        ...
        return async () => {
            ...
            await MessageV1.encode(alice.keystore, encodedMessage, alice.publicKeyBundle, bobKeys, timestamp);
        };
    }));
};
const encodeV2 = () => {
