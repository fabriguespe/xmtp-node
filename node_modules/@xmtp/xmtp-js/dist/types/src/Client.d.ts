...
export declare type PreEventCallback = () => Promise<void>;
/**
...
export declare type PreEventCallbackOptions = {
    /**
 ...
 */
export declare type ClientOptions = Flatten<NetworkOptions & KeyStoreOptions & ContentOptions & LegacyOptions & PreEventCallbackOptions>;
/**
