...
import { conversationReference, publicKey, keystore, invitation } from '@xmtp/proto';
...
export declare const topicDataToConversationReference: ({ invitation, createdNs, peerAddress, }: TopicData) => conversationReference.ConversationReference;
