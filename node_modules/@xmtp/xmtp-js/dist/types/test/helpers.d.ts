...
export declare const newLocalHostClient: (opts?: Partial<import("../src/utils/typedefs").Flatten<import("../src").NetworkOptions & import("../src").KeyStoreOptions & import("../src").ContentOptions & import("../src").LegacyOptions & import("../src/Client").PreEventCallbackOptions>> | undefined) => Promise<Client>;
export declare const newLocalHostClientWithCustomWallet: (opts?: Partial<import("../src/utils/typedefs").Flatten<import("../src").NetworkOptions & import("../src").KeyStoreOptions & import("../src").ContentOptions & import("../src").LegacyOptions & import("../src/Client").PreEventCallbackOptions>> | undefined) => Promise<Client>;
export declare const newDevClient: (opts?: Partial<import("../src/utils/typedefs").Flatten<import("../src").NetworkOptions & import("../src").KeyStoreOptions & import("../src").ContentOptions & import("../src").LegacyOptions & import("../src/Client").PreEventCallbackOptions>> | undefined) => Promise<Client>;
