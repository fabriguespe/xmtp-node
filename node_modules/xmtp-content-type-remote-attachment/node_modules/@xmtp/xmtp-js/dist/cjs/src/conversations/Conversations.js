        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const sealed of invites) {
                try {
                    ...
                    newConvos.push(yield Conversation_1.ConversationV2.create(this.client, unsealed, sealed.v1.header));
                }
                catch (e) {
    ...
    newConversation(peerAddress, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.v2Cache.load(({ latestSeen, existing }) => __awaiter(this, void 0, void 0, function* () {
                ...
                v2Convo = yield Conversation_1.ConversationV2.create(this.client, invitation, sealedInvite.v1.header);
                return [v2Convo];
            }));
            ...
            for (const convoExport of convoExports) {
                try {
                    if (convoExport.version === 'v1') {
                        v1Exports.push(Conversation_1.ConversationV1.fromExport(this.client, convoExport));
                    }
                    else if (convoExport.version === 'v2') {
                        v2Exports.push(Conversation_1.ConversationV2.fromExport(this.client, convoExport));
                    }
                }
                catch (e) {
