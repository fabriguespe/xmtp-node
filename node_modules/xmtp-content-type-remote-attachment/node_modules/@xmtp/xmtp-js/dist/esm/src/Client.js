...
import { SignedPublicKeyBundle, PrivateKeyBundleV1, PrivateKeyBundleV2, } from './crypto';
...
export default class Client {
    ...
    static create(wallet, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const keystore = yield InMemoryKeystore.create(keys);
