...
export declare const newLocalHostClient: (opts?: Partial<import("../src/utils/typedefs").Flatten<{
    env: "local" | "dev" | "production";
    apiUrl: string | undefined;
    appVersion?: string | undefined;
} & {
    keyStoreType: import("../src").KeyStoreType;
    privateKeyOverride?: Uint8Array | undefined;
} & {
    codecs: ContentCodec<any>[];
    maxContentSize: number;
} & {
    publishLegacyContact?: boolean | undefined;
}>> | undefined) => Promise<Client>;
export declare const newLocalHostClientWithCustomWallet: (opts?: Partial<import("../src/utils/typedefs").Flatten<{
    env: "local" | "dev" | "production";
    apiUrl: string | undefined;
    appVersion?: string | undefined;
} & {
...
export declare const newDevClient: (opts?: Partial<import("../src/utils/typedefs").Flatten<{
    env: "local" | "dev" | "production";
    apiUrl: string | undefined;
    appVersion?: string | undefined;
} & {
